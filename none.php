...
for($row=0;$row<$max;$row++){
	...
	elseif($lat=="#ANT1*"){
		...
		$none.="<tr><td><p><span style=\"color:red\">Ant. 1 </span>$antlat</p></td>
	...
	elseif($lat=="#ANT2*"){
		...
		$none.="<tr><td><p><span style=\"color:red\">Ant. 2 </span>$antlat</p></td>
	...
	elseif($lat=="#ANT3*"){
		...
		$none.="<tr><td><p><span style=\"color:red\">Ant. 3 </span>$antlat</p></td>
